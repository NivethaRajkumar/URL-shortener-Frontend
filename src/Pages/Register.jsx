...
const Register = () => {
  // Initialize state with default values to keep inputs controlled
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${apiurl}/user/signup`, payload);
      ...
      <div className="container">
        <div className="h-100 d-flex flex-row align-items-center justify-content-center">
          <form onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="bg-primary border border-radius">
              Register
            </Button>
          </form>
        </div>
